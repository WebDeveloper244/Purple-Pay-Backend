...
const _EmailService =   require('./routes/contactUsEmailManagementRoute');
// const _ContactUsManagement =   require('./routes/ContactUsManagementRoute');

//*****UsingRoutes*****//
app.use(express.static(path.join(__dirname, '/front-end')));
app.use('/emailService',_EmailService)
// app.use('/contactUsManagement',_ContactUsManagement)
//*****UsingRoutes*****//
